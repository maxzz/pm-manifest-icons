...
export function DefFieldTypes() {
    return (_jsxs(_Fragment, { children: [SvgSymbolFieldEdt(), SvgSymbolFieldPsw(), SvgSymbolFieldChk(), SvgSymbolFieldLst(), SvgSymbolFieldTxt(), SvgSymbolFieldBtn(), SvgSymbolFieldUseIt0(), SvgSymbolFieldUseIt1()] }));
}
